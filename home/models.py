...
class Home(models.Model):
	...
	home_page_category  = models.IntegerField(default=1)
	resume			    = models.FileField(upload_to="uploads/home/resume", default="")
	file_name 			= models.CharField(max_length=100, default="Resume.pdf")
