...
from contact.views                   import  handle_contact
from videos.views                    import show_videos 
from ckeditor_uploader               import urls
from django.conf                     import  settings
from django.conf.urls.static         import  static
from django.contrib.staticfiles.urls import staticfiles_urlpatterns
from SeanCodeMedia                   import  settings
from home.views                      import download_resume
...
urlpatterns = [
    ...
    path('videos/', show_videos),
    path('admin/', admin.site.urls),
    path('ckeditor/', include('ckeditor_uploader.urls')),
    path('contact/', handle_contact),
    path("resume/", download_resume)
